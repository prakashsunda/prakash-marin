...
function marinfrontpagesectionsscroll( section_id ){
 ...
 jQuery('body').on('click', '#sub-accordion-panel-marin_frontpage_sections .control-subsection .accordion-section-title', function(event) {
        var section_id = jQuery(this).parent('.control-subsection').attr('id');
        marinfrontpagesectionsscroll( section_id );
});
