 ...
 */
function marin_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function marin_sanitize_html( $html ) {
 ...
 */
function marin_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function marin_sanitize_range_value( $number, $setting ) {
 ...
 */
function marin_sanitize_select( $input, $setting ) {
 ...
 */
function marin_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function marin_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function marin_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}