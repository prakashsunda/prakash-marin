 ...
 *
 * @package     marin
 * @copyright   Copyright (c) 2022, marin
 * @since       1.0
 */
...
class marin_Icon_Picker_Control extends WP_Customize_Control {


	private $icons = false;

	public function __construct( $manager, $id, $args = array(), $options = array() ) {
		$this->icons = $this->marin_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'fonticonpicker-css', MARIN_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );

		wp_enqueue_script( 'fonticonpicker-js', MARIN_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
