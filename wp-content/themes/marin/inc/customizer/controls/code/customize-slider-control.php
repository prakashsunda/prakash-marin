...
/**
 * Class marin_Customize_Slider_Control
 */
class marin_Customize_Slider_Control extends marin_Customize_Base_Control {
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			<div class="marin-slider">
				<div id="custom-handle" class="ui-slider-handle"></div>
			</div>
			<div class="marin-slider-input">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span
							class="screen-reader-text"><?php esc_html_e( 'Reset', 'marin' ); ?></span></span>
			</div>
		</div>
