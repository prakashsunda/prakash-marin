...
/**
 * Class marin_Customize_Radio_Buttonset_Control
 */
class marin_Customize_Radio_Buttonset_Control extends marin_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'marin-radio-buttonset';
