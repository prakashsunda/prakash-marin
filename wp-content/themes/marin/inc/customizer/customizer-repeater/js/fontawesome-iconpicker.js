(function ($) {
    ...
    wp.marincustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                marin_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.marincustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.marincustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.marincustomizerRepeater.iconPickerToggle($(this));
        });
