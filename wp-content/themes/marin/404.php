	...
	<div class="av-container">
		<div class="av-columns-area wow fadeInUp">
			<div class="av-column-6 text-center mx-auto">
				<div class="card404">	
						<h1><?php esc_html_e( '4', 'marin' ); ?><span class="card404icon"><i class="fa fa-wrench"></i></span><?php esc_html_e( '4', 'marin' ); ?></h1>  
						<h4><?php esc_html_e( 'Page Not Found', 'marin' ); ?></h4>  
						<p><?php esc_html_e( 'Ooups! We can’t find the page you’re looking for', 'marin' ); ?></p> 

					<div class="card404-btn mt-3">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="av-btn av-btn-primary av-btn-bubble"> <?php esc_html_e( 'Go To Home', 'marin' ); ?> <i class="fa fa-arrow-right"></i> <span class="bubble_effect"><span class="circle top-left"></span> <span class="circle top-left"></span> <span class="circle top-left"></span> <span class="button effect-button"></span> <span class="circle bottom-right"></span> <span class="circle bottom-right"></span> <span class="circle bottom-right"></span></span></a>
					</div>
				</div>
			</div>
		</div>
